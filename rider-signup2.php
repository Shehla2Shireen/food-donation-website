            ...
            <div class="col login-form-2 " id="login-form">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="text-area" placeholder="Bike No *" value="" name="bike" required />
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="text-area" placeholder="License No *" value="" name="license" required />
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" id="text-area" placeholder="City *" value="" name="city" required />
                    </div>
                ...
                if (isset($_POST['submitn'])) {
                    ...
                    $sql = "INSERT INTO `rider` (`Rider_id`, `Bike_no`, `License_no`, `Status`, `city`, `p_id`) VALUES ('NULL', '$bike', '$license', 'Available', '$city', {$_SESSION['p_id']});";
